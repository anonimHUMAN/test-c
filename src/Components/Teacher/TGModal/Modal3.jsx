                            ...
                            <div className="px-8 py-6 lg:px-8">
                                <div className="w-full max-w-md p-3  border-none bg-gray-200 rounded-lg  dark:bg-gray-800 dark:border-gray-700 ">
                                    ...
                                    <div className="flex flex-col pb-10">
                                        ...
                                        <p className="mb-1 text-xl  text-gray-900 dark:text-white"><strong>Subject : </strong>{data.subject}</p>
                                        <p className="mb-1 text-xl  text-gray-900 dark:text-white"><strong>Groups : </strong>5</p>
