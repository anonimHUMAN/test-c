...
import Modal2 from "./TGModal/PostModal";
    ...
    async function data() {
        ...
        if (new Date(tokenDate) < new Date()) {
            ...
            if (DATA.data.message == "Token wrong!") {
                ...
                setTeachStudents(DATA.data.data)
            }
        }
    }
    const logout = async () => {
    ...
    return (
        <div className={`App ${isDarkMode ? 'dark' : 'light'}`}>
            ...
            <main className="bg-white dark:bg-gray-900 h-screen pt-10">
                ...
                {modal1 && <Modal1 student={tStudent} getAll={data} fn={chModal1} />}
                {/* <!-- Modal post --> */}
                {modal2 && <Modal2 fn={chModal2} getAll={data} />}
                {/* <!-- Modal profile --> */}
                {modal3 && <Modal3 data={tStudent} fn={chModal3} />}
